...
class OwlReadyOntologyParsingError(Exception):
    pass
...
disjoints = {
    "http://www.w3.org/2002/07/owl#DisjointClasses": (
    ...
    "http://www.w3.org/2002/07/owl#DisjointAnnotationProperties": (
        "http://www.w3.org/2002/07/owl#AllDisjointProperties",
        "http://www.w3.org/2002/07/owl#propertyDisjointWith",
        "http://www.w3.org/2002/07/owl#members",
    ),
    "http://www.w3.org/2002/07/owl#DifferentIndividuals": (
...
class OWLXMLParser(Parser):
    ...
    def parse(self, source, graph, **kwargs):
        if kwargs.get("encoding") not in [None, "utf-8"]:
            warn(
                f"OWL/XML files are always utf-8 encoded, "
        ...
        if hasattr(source, "file"):
            ...
            if hasattr(source._InputSource__bytefile, "wrapped"):
                self.owl_parse(
                    source._InputSource__bytefile.read(),
                    on_prepare_obj=None,
                    on_prepare_data=None,
                    new_blank=None,
                    default_base="",
    ...
    def owl_parse(
        ...
        def new_list(lst):
            ...
            if lst:
                for i in range(len(lst) - 1):
                    on_prepare_triple(
                        bn, "http://www.w3.org/1999/02/22-rdf-syntax-ns#first", lst[i]
                    )
                    bn_next = new_blank()
                    on_prepare_obj(
                        bn, "http://www.w3.org/1999/02/22-rdf-syntax-ns#rest", bn_next
                    )
                    bn = bn_next
                on_prepare_triple(
                    bn, "http://www.w3.org/1999/02/22-rdf-syntax-ns#first", lst[-1]
                )
                on_prepare_obj(
                    bn,
        ...
        def get_IRI(attrs):
            if "IRI" in attrs:
                ...
                if not iri:
                    return ontology_iri
                if iri.startswith("#") or iri.startswith("/"):
                    iri = ontology_iri + iri
                if iri.endswith("/"):
                    iri = iri[:-1]
                if "//" not in iri:
                    return urllib.parse.urljoin(prefixes[""], iri)
                return iri
        ...
        def startElement(tag, attrs):
            ...
            if tag == "http://www.w3.org/2002/07/owl#Prefix":
                ...
                iri = get_IRI(attrs)
                if in_declaration:
                    on_prepare_obj(iri, rdf_type, types[tag])
                objs.append(iri)

            elif tag == "http://www.w3.org/2002/07/owl#Datatype":
                objs.append(get_IRI(attrs))

            elif tag == "http://www.w3.org/2002/07/owl#Literal":
                current_attrs = attrs

            elif (
                (tag == "http://www.w3.org/2002/07/owl#ObjectIntersectionOf")
                or (tag == "http://www.w3.org/2002/07/owl#ObjectUnionOf")
                or (tag == "http://www.w3.org/2002/07/owl#ObjectOneOf")
                or (tag == "http://www.w3.org/2002/07/owl#DataOneOf")
                or (tag == "http://www.w3.org/2002/07/owl#DataIntersectionOf")
                or (tag == "http://www.w3.org/2002/07/owl#DataUnionOf")
                or (tag == "http://www.w3.org/2002/07/owl#DisjointClasses")
                or (tag == "http://www.w3.org/2002/07/owl#DisjointObjectProperties")
                or (tag == "http://www.w3.org/2002/07/owl#DisjointDataProperties")
                or (tag == "http://www.w3.org/2002/07/owl#DifferentIndividuals")
            ):
                objs.append("(")

            elif (
                (tag == "http://www.w3.org/2002/07/owl#ObjectExactCardinality")
                or (tag == "http://www.w3.org/2002/07/owl#ObjectMinCardinality")
                or (tag == "http://www.w3.org/2002/07/owl#ObjectMaxCardinality")
                or (tag == "http://www.w3.org/2002/07/owl#DataExactCardinality")
                or (tag == "http://www.w3.org/2002/07/owl#DataMinCardinality")
                or (tag == "http://www.w3.org/2002/07/owl#DataMaxCardinality")
            ):
                objs.append("(")
                last_cardinality = attrs["cardinality"]

            elif tag == "http://www.w3.org/2002/07/owl#AnonymousIndividual":
                objs.append(new_blank())

            elif tag == "http://www.w3.org/2002/07/owl#SubObjectPropertyOf":
                in_prop_chain = False

            elif (
                (tag == "http://www.w3.org/2002/07/owl#ObjectInverseOf")
                or (tag == "http://www.w3.org/2002/07/owl#DataInverseOf")
                or (tag == "http://www.w3.org/2002/07/owl#inverseOf")
            ):
                objs.append(new_blank())
                ...
                on_prepare_obj(
                    ontology_iri, rdf_type, "http://www.w3.org/2002/07/owl#Ontology"
                )
            ...
            elif (tag == "RDF") or (tag == "rdf:RDF"):
                raise ValueError(
                    "Not an OWL/XML file! (It seems to be an OWL/RDF file)"
                )
        ...
        def endElement(tag):
            ...
            if tag == "http://www.w3.org/2002/07/owl#Declaration":
                ...
                if lang:
                    objs.append((current_content, "@%s" % lang))
                else:
                    d = current_attrs.get("datatypeIRI", "")
                    if d in INT_DATATYPES:
                        o = int(current_content)
                    elif d in FLOAT_DATATYPES:
                        o = float(current_content)
                    else:
                        o = current_content
                    objs.append((o, d))

            elif (
                (tag == "http://www.w3.org/2002/07/owl#SubClassOf")
                or (tag == "http://www.w3.org/2002/07/owl#SubObjectPropertyOf")
                or (tag == "http://www.w3.org/2002/07/owl#SubDataPropertyOf")
                or (tag == "http://www.w3.org/2002/07/owl#SubAnnotationPropertyOf")
            ):
                parent = objs.pop()
                child = objs.pop()
                if (
                    tag == "http://www.w3.org/2002/07/owl#SubObjectPropertyOf"
                ) and in_prop_chain:
                ...
                if annots:
                    purge_annotations((child, relation, parent))
                ...
                if annots:
                    purge_annotations((child, rdf_type, parent))

            elif (
                (tag == "http://www.w3.org/2002/07/owl#EquivalentClasses")
                or (tag == "http://www.w3.org/2002/07/owl#EquivalentObjectProperties")
                or (tag == "http://www.w3.org/2002/07/owl#EquivalentDataProperties")
            ):
                o1 = objs.pop()
                o2 = objs.pop()
                if (isinstance(o1, int) and (o1 < 0)) or (
                    isinstance(o1, str) and o1.startswith("_")
                ):
                    o1, o2 = (
                        o2,
                        o1,
                    )  # Swap in order to have blank node at third position -- rapper seems to do that
                on_prepare_obj(o1, equivs[tag], o2)
                if annots:
                    purge_annotations((o1, equivs[tag], o2))

            elif (
                (tag == "http://www.w3.org/2002/07/owl#ObjectPropertyDomain")
                or (tag == "http://www.w3.org/2002/07/owl#DataPropertyDomain")
                or (tag == "http://www.w3.org/2002/07/owl#AnnotationPropertyDomain")
            ):
                val = objs.pop()
                obj = objs.pop()
                ...
                if annots:
                    purge_annotations(
                        (obj, "http://www.w3.org/2000/01/rdf-schema#domain", val)
                    )

            elif (
                (tag == "http://www.w3.org/2002/07/owl#ObjectPropertyRange")
                or (tag == "http://www.w3.org/2002/07/owl#DataPropertyRange")
                or (tag == "http://www.w3.org/2002/07/owl#AnnotationPropertyRange")
            ):
                val = objs.pop()
                obj = objs.pop()
                ...
                if annots:
                    purge_annotations(
                        (obj, "http://www.w3.org/2000/01/rdf-schema#range", val)
                    )
            ...
            elif (tag == "http://www.w3.org/2002/07/owl#InverseObjectProperties") or (
                tag == "http://www.w3.org/2002/07/owl#InverseDataProperties"
            ):
                ...
                if rel and (len(list_obj) == 2):
                    ...
                    if annots:
                        purge_annotations((list_obj[0], rel, list_obj[1]))
                    ...
                    if annots:
                        purge_annotations((iri, rdf_type, tag))
            ...
            elif (tag == "http://www.w3.org/2002/07/owl#ObjectComplementOf") or (
                tag == "http://www.w3.org/2002/07/owl#DataComplementOf"
            ):
                iri = new_blank()
                on_prepare_obj(iri, rdf_type, "http://www.w3.org/2002/07/owl#Class")
                on_prepare_obj(
                    iri, "http://www.w3.org/2002/07/owl#complementOf", objs[-1]
                )
                objs[-1] = iri
                ...
                iri = new_blank()
                on_prepare_obj(
                    iri, rdf_type, "http://www.w3.org/2002/07/owl#Restriction"
                )
                on_prepare_obj(
                    iri, "http://www.w3.org/2002/07/owl#onProperty", objs.pop(-2)
                )
                ...
                if len(values) == 2:  # Qualified
                    ...
                    on_prepare_obj(
                        iri, "http://www.w3.org/2002/07/owl#onProperty", values[-2]
                    )
                    if isinstance(objs[-1], str) and objs[-1].startswith(
                        "http://www.w3.org/2001/XMLSchema"
                    ):
                        on_prepare_obj(
                            iri, "http://www.w3.org/2002/07/owl#onDataRange", values[-1]
                        )
                    else:
                        on_prepare_obj(
                            iri, "http://www.w3.org/2002/07/owl#onClass", values[-1]
                        )
                else:  # Non qualified
                    tag = card_restrs[tag]
                    on_prepare_obj(
                        iri, "http://www.w3.org/2002/07/owl#onProperty", values[-1]
                    )
                on_prepare_data(
                    iri,
                    tag,
                ...
                iri = new_blank()
                on_prepare_obj(
                    iri, rdf_type, "http://www.w3.org/2000/01/rdf-schema#Datatype"
                )
                on_prepare_obj(iri, "http://www.w3.org/2002/07/owl#oneOf", list_iri)
                objs[start:] = [iri]
                ...
                list_iri = new_list(objs[start + 1 :])
                iri = new_blank()
                if isinstance(objs[start + 1 :][0], str) and objs[start + 1 :][
                    0
                    ...
                    on_prepare_obj(iri, rdf_type, "http://www.w3.org/2002/07/owl#Class")
                if (tag == "http://www.w3.org/2002/07/owl#ObjectIntersectionOf") or (
                    tag == "http://www.w3.org/2002/07/owl#DataIntersectionOf"
                ):
                    on_prepare_obj(
                        iri, "http://www.w3.org/2002/07/owl#intersectionOf", list_iri
                    )
                else:
                    on_prepare_obj(
                        iri, "http://www.w3.org/2002/07/owl#unionOf", list_iri
                    )
                objs[start:] = [iri]
                ...
                if annots:
                    purge_annotations((objs[-2], objs[-3], objs[-1]))
                ...
                objs[start:] = [bn]
                on_prepare_obj(
                    bn, rdf_type, "http://www.w3.org/2000/01/rdf-schema#Datatype"
                )
                on_prepare_obj(bn, "http://www.w3.org/2002/07/owl#onDatatype", datatype)
                on_prepare_obj(
                    bn, "http://www.w3.org/2002/07/owl#withRestrictions", list_bns
                )
                ...
                on_prepare_obj(
                    objs[-2], "http://www.w3.org/2002/07/owl#sameAs", objs[-1]
                )
                del objs[-2:]
        ...
        def purge_annotations(on_iri):
            ...
            if isinstance(on_iri, tuple):
                ...
                on_prepare_obj(
                    on_iri, "http://www.w3.org/2002/07/owl#annotatedSource", s
                )
                on_prepare_obj(
                    on_iri, "http://www.w3.org/2002/07/owl#annotatedProperty", p
                )
                on_prepare_triple(
                    on_iri, "http://www.w3.org/2002/07/owl#annotatedTarget", o
                )

            for prop_iri, value in annots:
                on_prepare_triple(on_iri, prop_iri, value)
            annots = []
        ...
        try:
            parser.Parse(source)
            try:
                self.graph.parse(data=self.ntriples, format="ntriples")
            except Exception as e:
                warn(f"Exception {e}")

        except Exception as e:
            raise OwlReadyOntologyParsingError(
                "OWL/XML parsing error in data: line %s, column %s."
                % (
